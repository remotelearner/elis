 ...
 */
class elisprogram extends \core\plugininfo\base {
    ...
    public $typerootdir = '/local/elisprogram/plugins/';
    /** @var string the plugin name, eg. assignment, ldap */
    public $name = 'elisprogram';
    /** @var string the localized plugin name */
    public $displayname = 'ELIS Program Plugins';
