...
/**
 * This class defines usetenrol subplugininfo
 */
class usetenrol extends \core\plugininfo\base {
    ...
    public $typerootdir = '/local/elisprogram/enrol/userset/';
    /** @var string the plugin name, eg. assignment, ldap */
    public $name = 'usetenrol';
    /** @var string the localized plugin name */
    public $displayname = 'ELIS Program Userset Enrol Plugins';
