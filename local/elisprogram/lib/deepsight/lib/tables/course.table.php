 ...
 */
class deepsight_datatable_course extends deepsight_datatable_standard {
    ...
    protected function get_join_sql(array $filters=array()) {
        ...
        if (!empty($activecustomfields)) {
            $joinsql[] = 'JOIN {context} ctx ON ctx.instanceid = element.id AND ctx.contextlevel='.CONTEXT_ELIS_COURSE;
