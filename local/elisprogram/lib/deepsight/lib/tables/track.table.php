...
/**
 * A datatable implementation for lists of tracks.
 */
class deepsight_datatable_track extends deepsight_datatable_standard {
    ...
    protected function get_filters() {
        ...
        $filters = array(
            ...
            new deepsight_filter_searchselect($this->DB, 'program_name', $langpgmname, array('pgm.name' => $langpgmname),
                                              $this->endpoint, curriculum::TABLE, 'name'),
    ...
    protected function get_initial_filters() {
        return array('name', 'idnumber', 'program_name');
    }
