 ...
 */
class deepsight_datatable_program extends deepsight_datatable_standard {

    /**
     * @var string The main table results are pulled from. This forms that FROM clause.
     */
    protected $main_table = 'local_elisprogram_pgm';
    ...
    protected function get_join_sql(array $filters=array()) {
        ...
        if (!empty($activecustomfields)) {
            $joinsql[] = 'JOIN {context} ctx ON ctx.instanceid = element.id AND ctx.contextlevel='.CONTEXT_ELIS_PROGRAM;
