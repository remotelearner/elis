...
/**
 * A base class for managing course - program associations. (one course, multiple programs)
 */
class deepsight_datatable_courseprogram_base extends deepsight_datatable_program {
 ...
 */
class deepsight_datatable_courseprogram_assigned extends deepsight_datatable_courseprogram_base {
    ...
    public function get_actions() {
        ...
        // Edit action.
        $edit = new deepsight_action_courseprogram_edit($this->DB, 'courseprogram_edit');
        $edit->endpoint = (strpos($this->endpoint, '?') !== false)
                ? $this->endpoint.'&m=action' : $this->endpoint.'?m=action';
        $actions[] = $edit;

        // Unassign action.
        $unassign = new deepsight_action_courseprogram_unassign($this->DB, 'courseprogram_unassign');
    ...
    protected function get_join_sql(array $filters=array()) {
        ...
        $joinsql[] = 'JOIN {'.curriculumcourse::TABLE.'} curcrs
                           ON curcrs.courseid='.$this->courseid.' AND curcrs.curriculumid = element.id';
        return $joinsql;
    }
}

/**
 * A datatable listing programs that are available to assign to the course, and are not currently assigned.
 */
class deepsight_datatable_courseprogram_available extends deepsight_datatable_courseprogram_base {
    ...
    public function get_actions() {
        ...
        // Assign action.
        $assign = new deepsight_action_courseprogram_assign($this->DB, 'courseprogram_assign');
