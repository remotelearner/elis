...
$.fn.deepsight_action_usersettrack_assignedit = function(options) {
    this.default_opts = {
        rowdata: {},
        parent: null,
        sesskey: null,
        ...
        autoenroldefault : 0,
        desc_single: 'You are about to assign this track to this userset. Continue?',
        desc_multiple: 'You are about to assign these tracks to this userset. Continue?',
        mode: 'assign',
    ...
    this.render_action = function() {
        ...
        var checkboxid = 'deepsight_action_usertrack_assigned_'+elementid;
        ...
        var actionpanel = $('<div><div>').addClass(opts.actionclass).addClass('deepsight_action_usersettrack_assignedit').css('display', 'none');
                ...
                if (typeof(data.result) != 'undefined' && data.result == 'success') {
                    ...
                    if (opts.parentid != 'bulklist') {
                        if (opts.mode == 'assign') {
                            ...
                            opts.parent.find('.field_clsttrk_autoenrol').html(autoenroltext);
