...
/**
 * DeepSight Track-Class Assign/Edit Action
 * An action used in track - class associations. Displays a message, and a checkbox for the "autoenrol" flag.
 *
 * Usage:
 *     $('[button selector]').each(function() { $(this).deepsight_action_trackclass_assignedit(); });
 *
 * Required Options:
 ...
 * @return object The main object for easy chaining.
 */
$.fn.deepsight_action_trackclass_assignedit = function(options) {
    this.default_opts = {
        rowdata: {},
        parent: null,
        sesskey: null,
     ...
     * @return object The jQuery object for the rendered action.
     */
    this.render_action = function() {
        ...
        var checkboxid = 'deepsight_action_trackclass_assigned_'+elementid;
        ...
        var actionpanel = $('<div><div>')
            ...
            .addClass('deepsight_action_trackclass_assignedit')
            .css('display', 'none');
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (typeof(data.result) != 'undefined' && data.result == 'success') {
                    ds_debug('[deepsight_action_trackclass.complete_action] Completed action, recevied data:', data);
                    if (opts.parentid != 'bulklist') {
                        if (opts.mode == 'assign') {
                            ...
                            opts.parent.find('.field_trkass_autoenrol').html(autoenroltext);
