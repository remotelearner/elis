...
$string['elisprogram:class_enrol'] = 'Manage class instance enrollments';
$string['elisprogram:class_enrol_userset_user'] = 'Manage user set\'s users\' class instance enrollments';
$string['elisprogram:notify_classenrol'] = 'Receive class enrollment notifications';
$string['elisprogram:notify_trackenrol'] = 'Receive track enrollment notifications';
$string['elisprogram:overrideclasslimit'] = 'Can over enroll a class';
$string['elisprogram:program_enrol'] = 'Manage program enrollments';
$string['elisprogram:program_enrol_userset_user'] = 'Manage user set\'s users\' program enrollments';
$string['elisprogram:track_enrol'] = 'Manage track enrollments';
$string['elisprogram:track_enrol_userset_user'] = 'Manage user set\'s users\' track enrollments';
$string['enrol'] = 'Enroll';
...
$string['subplugintype_usetenrol_plural'] = 'User set enrollment methods';
