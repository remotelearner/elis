...
/**
 * Test userset themes plugin.
 * @group elisprogram_usetthemes
 * @group local_elisprogram
 */
class usersetthemes_testcase extends elis_database_test {
    /**
     * Test installing.
     */
    public function test_install() {
        ...
        $this->assertTrue(xmldb_elisprogram_usetthemes_install());

        // Check the "group" field and owner.
        $field = $DB->get_record(field::TABLE, array('shortname' => '_elis_userset_themepriority'));
        ...
        $field = $DB->get_record(field::TABLE, array('shortname' => '_elis_userset_theme'));
        $this->assertNotEmpty($field->id);
