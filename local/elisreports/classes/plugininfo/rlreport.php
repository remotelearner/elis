...
namespace local_elisreports\plugininfo;

defined('MOODLE_INTERNAL') || die();

/**
 * This class defines rlreport subplugininfo
 */
class rlreport extends \core\plugininfo\base {
    ...
    public $typerootdir = '/local/elisreports/instances/';
    /** @var string the plugin name, eg. assignment, ldap */
    public $name = 'rlreport';
    /** @var string the localized plugin name */
    public $displayname = 'ELIS Report instances';
