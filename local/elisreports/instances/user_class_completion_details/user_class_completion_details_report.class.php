...
require_once($CFG->dirroot .'/local/elisreports/instances/user_class_completion/user_class_completion_report.class.php');
...
class user_class_completion_details_report extends user_class_completion_report {
    ...
    function get_columns() {
        ...
        // Completion date
        $completiondateheading = get_string('column_completiondate', $this->languagefile);
        $completiondatecolumn = new table_report_column('stu.completetime', $completiondateheading, 'completiondate');
        $result[] = $completiondatecolumn;
    ...
    function get_config_url() {
        global $CFG;
        return $CFG->wwwroot .'/local/elisreports/render_report_page?report='. $this->parentname .'" target="_top';
    }
