...
abstract class php_report {
    ...
    function init_filter($id, $init_data = true) {
        ...
        if (!isset($this->filter)) {
            ...
            $dynamic_report_filter_url = $CFG->wwwroot .'/local/elisreports/dynamicreport.php?id='. $id;
    ...
    function get_config_url() {
        global $CFG;
        return $CFG->wwwroot .'/local/elisreports/config_params.php?id='. $this->id .'&showcancel=1'; // TBD ???
    }
    ...
    static function get_report_filename($shortname) {
        ...
        $base_path = $CFG->dirroot .'/local/elisreports/instances/';
    ...
    function display_header() {
        ...
        $PAGE->requires->js('/local/elisreports/js/reportblock.js'); // TBD: is this even used?
        ...
        if ($this->shouldredirecttofilter()) {
            ...
            $_GET['mode'] = 'bare';
            $_GET['url'] = "{$CFG->wwwroot}/local/elisreports/config_params.php";
        ...
        $stylesheet_web_path = $CFG->wwwroot .'/local/elisreports/instances/'. $folder_name .'/styles.css';
