...
/**
 * Tests webservice method local_datahub_elis_userset_update.
 * @group local_datahub
 * @group local_datahub_ws
 */
class local_datahub_ws_elis_userset_update_testcase extends rlip_test_ws {
    ...
    public function test_failure(array $us) {
        ...
        $response = local_datahub_elis_userset_update::userset_update($us);
    }
}