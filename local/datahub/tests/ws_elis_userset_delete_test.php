...
if (file_exists($CFG->dirroot.'/local/elisprogram/lib/setup.php')) {
    ...
    require_once($CFG->dirroot.'/local/elisprogram/enrol/userset/moodleprofile/userset_profile.class.php');
    require_once($dirname.'/../ws/elis/userset_delete.class.php');
}

/**
 * Tests webservice method local_datahub_elis_userset_delete.
 * @group local_datahub
 * @group local_datahub_ws
 */
class local_datahub_ws_elis_userset_delete_testcase extends rlip_test_ws {
    ...
    public function test_success() {
        ...
        $this->assertEquals(get_string('ws_userset_delete_success_code', 'local_datahub',
                    get_string('ws_userset_delete_recursive', 'local_datahub')), $response['messagecode']);
        $this->assertEquals(get_string('ws_userset_delete_success_msg', 'local_datahub',
                    get_string('ws_userset_delete_subsets', 'local_datahub')), $response['message']);
    }
