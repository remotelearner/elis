...
/**
 * A test object that replaces the sendemail function in rlip_importplugin_version1elis for easy testing.
 */
class rlip_importplugin_version1elis_fakeemail extends rlip_importplugin_version1elis {
    /**
     * Send the email.
     *
