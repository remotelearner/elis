 ...
 */
class local_datahub_elis_class_enrolment_create extends external_api {
    ...
    public static function class_enrolment_create(array $data) {
        ...
        if (!empty($stu->id)) {
            return array(
                'messagecode' => get_string('ws_class_enrolment_create_success_code', 'local_datahub'),
                'message' => get_string('ws_class_enrolment_create_success_msg', 'local_datahub'),
                'record' => $stu->to_array(),
            );
        } else {
