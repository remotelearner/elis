 ...
 */
class block_rldh_elis_program_enrolment_create extends external_api {
    ...
    public static function program_enrolment_create(array $data) {
        ...
        if (empty($data->program_idnumber) || !($curid = $DB->get_field('crlm_curriculum', 'id', array('idnumber' => $data->program_idnumber)))) {
            throw new data_object_exception('ws_program_enrolment_create_fail_invalid_program', 'block_rlip', '', $data);
        }
        ...
        if ($userid == false) {
            ...
            throw new data_object_exception('ws_program_enrolment_create_fail_invalid_user', 'block_rlip', '', $a);
        }
        ...
        if (!empty($stucur->id)) {
            return array(
                'messagecode' => get_string('ws_program_enrolment_create_success_code', 'block_rlip'),
                'message' => get_string('ws_program_enrolment_create_success_msg', 'block_rlip'),
                'record' => $stucur->to_array(),
            );
        } else {
            throw new data_object_exception('ws_program_enrolment_create_fail', 'block_rlip');
        }
    }
