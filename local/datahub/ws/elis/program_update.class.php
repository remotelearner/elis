 ...
 */
class local_datahub_elis_program_update extends external_api {
    ...
    public static function program_update(array $data) {
        ...
        if (!empty($prg->id)) {
            ...
            return array(
                'messagecode' => get_string('ws_program_update_success_code', 'local_datahub'),
                'message' => get_string('ws_program_update_success_msg', 'local_datahub'),
