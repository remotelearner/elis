 ...
 */
class local_datahub_elis_track_enrolment_create extends external_api {
    ...
    public static function track_enrolment_create(array $data) {
        ...
        if (usertrack::enrol($userid, $trackid)) {
            ...
            return array(
                'messagecode' => get_string('ws_track_enrolment_create_success_code', 'local_datahub'),
                'message' => get_string('ws_track_enrolment_create_success_msg', 'local_datahub'),
