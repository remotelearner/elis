...
$string['auto_enrol_warning'] = 'NOTE: this class instance is set to auto-enroll users, but is not from a required course description in the curriculum.  The auto-enroll function only applies to required course descriptions, so users will not be auto-enrolled in this class instance.';
$string['no_auto_enrol'] = 'NOTE: The auto-enroll flag cannot be set for this class instance in this track, because the associated course description is not a required course description in the curriculum.';
