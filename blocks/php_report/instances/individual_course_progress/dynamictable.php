...
//TBD: add custom_field_select filter files when completed!
...
if (is_array($fieldidlist)) {
    ...
    foreach ($fieldidlist as $field_id) {
        ...
        $subtable_data[] = array('course_field'  => $fieldname,
                                 ...
                                 'remove_fields' => $remove); // TBV
        $subtable_rowclass[] = 'course_field_row select_all_row';
        $count++;
    }
}
