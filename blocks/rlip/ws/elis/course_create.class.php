 ...
 */
class block_rldh_elis_course_create extends external_api {
    ...
    public static function course_create(array $data) {
        ...
        // Capability checking.
        require_capability('elis/program:course_create', get_system_context());
        ...
        if (isset($data->credits) && !(is_numeric($data->credits) && $data->credits >= 0)) {
            throw new data_object_exception('ws_course_create_fail_invalid_credits', 'block_rlip', '', $data);
        ...
        if (isset($data->completion_grade) && !(is_numeric($data->completion_grade) && $data->completion_grade >= 0 && $data->completion_grade <= 100)) {
            throw new data_object_exception('ws_course_create_fail_invalid_completion_grade', 'block_rlip', '', $data);
        }
        ...
        if (isset($data->assignment) && !empty($data->assignment)) {
            ...
            if ($curriculumid) {
                ...
                throw new data_object_exception('ws_course_create_fail_invalid_assignment', 'block_rlip', '', $data);
            }
        }
        ...
        if (isset($data->link) && !empty($data->link)) {
            ...
            if ($moodlecourseid) {
                ...
                throw new data_object_exception('ws_course_create_fail_invalid_link', 'block_rlip', '', $data);
            }
        }
        ...
        if (!empty($course->id)) {
            ...
            return array(
                'messagecode' => get_string('ws_course_create_success_code', 'block_rlip'),
                'message' => get_string('ws_course_create_success_msg', 'block_rlip'),
                'record' => array_merge($courserec, $courseobj),
            );
        } else {
            throw new data_object_exception('ws_course_create_fail', 'block_rlip');
        }
    }
