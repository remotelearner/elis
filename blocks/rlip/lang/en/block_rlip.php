...
$string['importexceedstimelimit_b'] = 'Import processing of entity \'{$a->entity}\' aborted due to time restrictions. Processed {$a->recordsprocessed} of {$a->totalrecords} total records. Import will continue at next cron.';
...
$string['manualimportexceedstimelimit'] = 'Import processing of entity \'{$a->entity}\' aborted due to time restrictions.';
$string['manualimportexceedstimelimit_b'] = 'Import processing of entity \'{$a->entity}\' aborted due to time restrictions. Processed {$a->recordsprocessed} of {$a->totalrecords} total records.';
...
$string['notificationemailmessage'] = 'The Integration Point Version 1 import plugin has run and generated the attached log file(s). Please view log file content for information regarding the success of the associated Integration Point task. ';
$string['notificationemailsubject'] = 'Integration Point {$a} logs(s)';
