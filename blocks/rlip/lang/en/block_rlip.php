...
$string['ws_user_update_fail_conflictingidfields'] = 'Conflicting identifying fields received {$a}';
...
$string['ws_user_update_fail_idfieldinvalid'] = 'Identifying user field {$a} is not a valid user.';
