...
$string['importinvalidlogfilepath'] = 'Log file access failed while importing lines from import file {$a->filename} due to invalid logfile path. Change \'{$a->logfilepath}\' to a valid logfile location on the settings page. Processed {$a->filesuccesses} of {$a->totalrecords} records.';
