 ...
 */
class block_rlip_ws_elis_program_enrolment_delete_test extends rlip_test {
    /**
    ...
    public function test_success() {
        ...
        $stucur = new curriculumstudent(array('curriculumid' => $prgid, 'userid' => $userid));
        $stucur->save();
        ...
        $this->assertFalse($DB->record_exists(curriculumstudent::TABLE, array('curriculumid' => $prgid, 'userid' => $userid)));
    }
