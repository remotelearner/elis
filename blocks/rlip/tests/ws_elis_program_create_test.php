...
/**
 * Tests webservice method block_rldh_elis_program_create.
 * @group block_rlip
 * @group block_rlip_ws
 */
class block_rlip_ws_elis_program_create_testcase extends rlip_test_ws {
    ...
    public function test_success() {
        ...
        $response = block_rldh_elis_program_create::program_create($program);
        ...
        $this->assertEquals(get_string('ws_program_create_success_code', 'block_rlip'), $response['messagecode']);
        $this->assertEquals(get_string('ws_program_create_success_msg', 'block_rlip'), $response['message']);
    ...
    public function test_failure(array $programtocreate) {
        ...
        $response = block_rldh_elis_program_create::program_create($programtocreate);
    }
}