...
/**
 * Tests webservice method block_rldh_elis_user_create.
 * @group block_rlip
 * @group block_rlip_ws
 */
class block_rlip_ws_elis_user_create_testcase extends rlip_test_ws {
    ...
    public function test_success() {
        ...
        $this->give_permissions(array('elis/program:user_create'));
        $response = block_rldh_elis_user_create::user_create($user);
        ...
        $this->assertEquals(get_string('ws_user_create_success_code', 'block_rlip'), $response['messagecode']);
        $this->assertEquals(get_string('ws_user_create_success_msg', 'block_rlip'), $response['message']);
