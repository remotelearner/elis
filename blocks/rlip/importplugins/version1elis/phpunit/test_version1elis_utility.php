...
class version1elis_utility_test extends PHPUnit_Framework_TestCase {
    ...
    public function pddataprovider() {
        ...
        $bogusobj->name = 'bogus';
        return array(
            array('Jan/02/2010', true, false, 0, 0, mktime(0, 0, 0, 1, 2, 2010)),
            array('01/02/2010', true, false, 0, 0, mktime(0, 0, 0, 1, 2, 2010)),
            ...
            array('JAN/02/2010 9:45', true, false, 0, 0, mktime(0, 0, 0, 1, 2, 2010)),
            array('jan/02/2010 9:45', true, true, 0, 0, mktime(9, 45, 0, 1, 2, 2010)),
            ...
            array('02-01-2010', true, false, 0, 0, mktime(0, 0, 0, 1, 2, 2010)),
            array('02-01-2010', false, false, 0, 0, false),
            array('2010.01.02', true, false, 0, 0, mktime(0, 0, 0, 1, 2, 2010)),
