...
$string['config_enrolment_schedule_file'] = 'The filename of the \'enrolment\' DH import file.';
$string['configlogfilelocation'] = 'The directory path, relative to moodledata, to the location of log files.';
$string['config_course_schedule_file'] = 'The filename of the \'course\' DH import file.';
...
$string['config_user_schedule_file'] = 'The filename of the \'user\' DH import file.';
