 ...
 */
class rlip_importprovider_createorupdateuser extends rlip_importprovider {
 ...
 */
class rlip_importprovider_createorupdatecourse extends rlip_importprovider {
    //fixed data to use as import data
    var $data;
 ...
 */
class rlip_importprovider_createorupdateenrolment extends rlip_importprovider {
    //fixed data to use as import data
    var $data;
