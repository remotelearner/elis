...
class linkpage extends pm_page {
    ...
    public function __construct(array $params=null) {
        ...
        $link_url = !empty($this->params['linkurl']) ? $this->params['linkurl'] : '';
        // the comma separated list of parameters we will look for
        $link_params = !empty($this->params['linkparams']) ? $this->params['linkparams'] : '';
        ...
        $this->set_url($link_url, $this->params);
    }
