...
function xmldb_elis_program_upgrade($oldversion=0) {
    ...
    if ($result && $oldversion < 2012123101) {
        ...
        upgrade_plugin_savepoint($result, 2012123101, 'elis', 'program');
    }

    if ($result && $oldversion < 2012123102) {
        ...
        upgrade_plugin_savepoint($result, 2012123102, 'elis', 'program');
    }

    // ELIS-7780: remove deprecated capabilites
    if ($result && $oldversion < 2012123103) {
    ...
    if ($result && $oldversion < 2012123108) {
