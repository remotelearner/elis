...
$string['pmclassform:waitlistenrol_help'] = '<p>on to automatically enroll students from the waitlist into the course description when an erolled student completes (passes or fails) the course description.</p>';
