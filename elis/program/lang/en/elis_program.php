...
$string['engineform:activate_this_rule'] = 'Activate this results engine';
$string['engineform:after_class_end'] = 'after Class Instance end date';
$string['engineform:after_class_start'] = 'after Class Instance start date';
$string['engineform:assigntotrack'] = 'Assign to Track';
$string['engineform:before_class_end'] = 'before Class Instance end date';
$string['engineform:class_grade'] = 'Class Instance grade';
$string['engineform:criterion'] = 'Criterion';
$string['engineform:event_trigger'] = 'Event trigger';
$string['engineform:execute_manually'] = 'Execute manually';
$string['engineform:manual_trigger'] = 'Manual trigger only';
$string['engineform:on'] = 'On';
$string['engineform:select_grade'] = 'Select which Class Instance grade value should be used to evaluate Student peformance for determing the result';
$string['engineform:result'] = 'Result';
$string['engineform:use_locked_grades'] = 'Use locked grades only';
$string['engineform:when_student_grade_set'] = 'When Student grade set';
$string['enrol'] = 'Enrol';
