...
$string['usersetprogramform:autoenrol_help'] = '<p>If this box is checked then new users will be enrolled in this curriculum when they are added to this userset.</p>';
$string['usersetprogramform_auto_enrol'] = 'Auto-enrol users into this curriculum when they are added to this cluster';
$string['usersetprogram_auto_enrol'] = 'Auto-enrol';
$string['usersetprogram_unassociated'] = 'Unassociated';
$string['userset_addcurr_instruction'] = 'Use the add drop down to LINK this cluster to a curriculum.';
$string['userset_cpyclustname'] = 'Cluster';
$string['userset_cpycurname'] = 'Curriculum';
$string['userset_cpycurr'] = 'Copy Curriculum';
$string['userset_cpycurr_instruction'] = 'Use the copy button to make a copy of a curriculum and link it to this cluster.';
...
$string['userset_info_group'] = 'Cluster Information';
