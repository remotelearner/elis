...
$string['completionform:required_help'] = '<p>Is the learning objective required to complete the course? Some objectives may be optional and therefore not required for course completion.</p>';
