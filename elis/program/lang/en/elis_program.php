...
$string['completionform:required'] = '<p>Is the element a required to complete the course? Some elements may be optional and therefore not required for course completion.</p>';
