...
$string['trackform:track_idnumber_help'] = '<p>Enter an id number for the track. This number will appear in the class id number for each class which is a part of the track.</p>';
