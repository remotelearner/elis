...
$string['userset_groupings_help'] = '<p>For this functionality to work, User Set grouping auto-assignment must be enabled globally for the site level and groupings must also be enabled on this site. This functionality does not currently extend to groups in courses.</p>';

$string['userset_groups'] = 'Allow course-level group population from User Sets';
$string['userset_groups_help'] = '<p>Enabling this setting allows groups to be automatically created for user population based on User Set enrolment.</p>
