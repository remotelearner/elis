        ...
        if (empty($this->id) && !$users) {
            ...
            foreach ($users as $user) {
                ...
                if ($selection) {
                    ...
                    $enrolmenttime = pm_gmt_from_usertime(mktime(0, 0, 0, $selection->enrolment_date->month, $selection->enrolment_date->day, $selection->enrolment_date->year));
                    $completetime = pm_gmt_from_usertime(mktime(0, 0, 0, $selection->completion_date->month, $selection->completion_date->day, $selection->completion_date->year));
                }
                $tabobj = new stdClass;
