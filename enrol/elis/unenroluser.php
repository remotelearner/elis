...
$url = new moodle_url('/enrol/elis/unenroluser.php', $returnurl->params());
$url->param('ue', $ueid);
...
if (!$plugin->allow_unenrol($instance) || $instance->enrol != 'elis' || !($plugin instanceof enrol_elis_plugin)) {
